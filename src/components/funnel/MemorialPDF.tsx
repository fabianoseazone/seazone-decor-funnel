...
const s = StyleSheet.create({
  ...
  headerLogoSub: { color: "rgba(255,255,255,0.5)", fontSize: 6, letterSpacing: 1, marginTop: 2 },
  headerTitleBox: {
    flex: 1,
  ...
  headerSub: { color: "rgba(255,255,255,0.75)", fontSize: 8, marginTop: 4 },

  // Info table
  infoBox: {
    borderWidth: 1, borderColor: GRAY_BORDER, borderRadius: 6,
    overflow: "hidden", marginBottom: 16,
  },
  infoRow: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: GRAY_BORDER },
  infoRowLast: { flexDirection: "row" },
  infoLabel: {
    width: 130, backgroundColor: GRAY_BG,
    padding: "7 10", fontFamily: "Helvetica-Bold", fontSize: 8, color: NAVY,
  },
  ...
  finRow: {
    ...
    padding: "6 12", borderBottomWidth: 1, borderBottomColor: GRAY_BORDER,
  },
  finLabel: { fontSize: 8, color: TEXT_MUTED },
  finValue: { fontSize: 8 },
  finTotal: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end",
    padding: "9 12", backgroundColor: GRAY_BG,
  },
  ...
  finTotalParcela: { fontSize: 7, color: TEXT_MUTED, marginTop: 2 },

  // Group
  groupHeader: {
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
    backgroundColor: NAVY, padding: "7 12", marginTop: 14, borderRadius: 4,
  },
  groupName: { color: "white", fontFamily: "Helvetica-Bold", fontSize: 9 },
  groupCount: { color: "rgba(255,255,255,0.55)", fontSize: 7 },
  ...
  productImgBox: {
    width: 34, height: 34, backgroundColor: GRAY_BORDER,
    borderRadius: 3, marginRight: 10,
  },
  productName: { flex: 1, fontSize: 8, lineHeight: 1.4 },
  productQtyBox: {
    width: 28, height: 20, backgroundColor: GRAY_BG,
    borderRadius: 3, borderWidth: 1, borderColor: GRAY_BORDER,
    alignItems: "center", justifyContent: "center", marginLeft: 8,
  },
  productQty: { fontSize: 8, fontFamily: "Helvetica-Bold", color: NAVY },
  badge: {
    backgroundColor: CORAL, borderRadius: 3,
    padding: "1 5", marginLeft: 6, alignSelf: "center",
  },
  ...
  footer: {
    ...
    flexDirection: "row", justifyContent: "space-between", alignItems: "center",
    paddingTop: 6, borderTopWidth: 1, borderTopColor: GRAY_BORDER,
  },
...
function ProductRow({ item, idx }: { item: MemorialItem; idx: number }) {
  ...
  return (
    <View style={[s.productRow, isAlt ? s.productRowAlt : {}]}>
      {item.imagemBase64 ? (
        <Image src={item.imagemBase64} style={s.productImg} />
      ) : (
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.header}>
          <View style={s.headerLogoBox}>
            <Text style={s.headerLogoText}>SZ</Text>
            <Text style={s.headerLogoSub}>DECOR</Text>
          </View>
        ...
        <View style={s.infoBox}>
          ...
          <InfoRow label="Tipologia / Pacote" value={tipologiaComposta || "—"} />
          <InfoRow label="Hóspedes" value={data.numHospedes ? `${data.numHospedes} hóspedes` : "—"} />
        ...
        <View style={s.finCard}>
          ...
          <View style={s.finTotal}>
            <View>
              ...
              <Text style={s.finTotalParcela}>15x de {fmt(data.total / 15)}</Text>
            </View>
